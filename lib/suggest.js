...
function suggest(value) {
  ...
  const real_answer = 'shandy'
  if (suggestions.includes(real_answer)) {
    console.log({
      top_weight: weighted[suggestions[0]],
      real_weight: weighted[real_answer]
    })
    log_sort(suggestions[0], real_answer, suggestions.indexOf(real_answer))
  }
